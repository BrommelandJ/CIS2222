...
<body>
    ...
    <form id="form1" runat="server">
        <div>
            <asp:DetailsView ID="DetailsView1" runat="server" Height="50px" Width="285px" AutoGenerateRows="False" DataKeyNames="BookID" DataSourceID="SqlDataSource2" AllowPaging="True">
                <Fields>
                    <asp:TemplateField HeaderText="Book ID" InsertVisible="False" SortExpression="BookID">
                        ...
                        <InsertItemTemplate>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Book ID Required"></asp:RequiredFieldValidator>
                        </InsertItemTemplate>
                        <ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="Title" SortExpression="Title">
                        ...
                        <InsertItemTemplate>
                            <asp:TextBox ID="TextBox1" runat="server" Text='<%# Bind("Title") %>'></asp:TextBox>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="TextBox1" ErrorMessage="Book Title Required"></asp:RequiredFieldValidator>
                        </InsertItemTemplate>
                        <ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="Last Read On" SortExpression="LastReadOn">
                        ...
                        <InsertItemTemplate>
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="TextBox2" ErrorMessage="Date Required"></asp:RequiredFieldValidator>
                        </InsertItemTemplate>
                        <ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="Page Count" SortExpression="PageCount">
                        ...
                        <InsertItemTemplate>
                            <asp:TextBox ID="TextBox3" runat="server" Text='<%# Bind("PageCount") %>'></asp:TextBox>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="TextBox3" ErrorMessage="Page Count Required"></asp:RequiredFieldValidator>
                        </InsertItemTemplate>
                        <ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="Year Published" SortExpression="YearPublished">
                        ...
                        <InsertItemTemplate>
                            <asp:TextBox ID="TextBox4" runat="server" Text='<%# Bind("YearPublished") %>'></asp:TextBox>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="TextBox4" ErrorMessage="Year Published Required"></asp:RequiredFieldValidator>
                        </InsertItemTemplate>
                        <ItemTemplate>
